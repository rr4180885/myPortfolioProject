...
const projects = [
    {
        ...
        category: "frontend",
        title : "project 1",
        description: "Lorm oissfjsodjfdjlfjdlsjflkdafkdjlsdafj sdfdjsfl dlfjldsjflsdjfljsdfljdfj",
        ...
        >
            <div className="container mx-auto">
                <div className="flex flex-col xl:flex-row xl:gap-[30px]">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <TooltipProvider delayDuration={100}>
                                    ...
                                    <TooltipTrigger className="w-[70px] h-[70px] rounded-full
                                        bg-white/5 flex justify-center items-center group">
                                            <span className=" text-white text-3xl group-hover:text-accent"><BsArrowUpRight/></span>
                                            {/* <div className="text-white group-hover:text-accent"> hola</div> */}
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>Live Project</p>
                                        </TooltipContent>
                                ...
                                <TooltipProvider delayDuration={100}>
                                    <Tooltip>
                                        <TooltipTrigger className="w-[70px] h-[70px] rounded-full
                                        bg-white/5 flex justify-center items-center group">
                                            <span className=" text-white text-3xl group-hover:text-accent"><BsGithub/></span>
                                            {/* <div className="text-white group-hover:text-accent"> hola</div> */}
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>GitHub Project</p>
                    ...
                    <div className="w-full xl:w-[50%] bg-trans">
                                    ...
                                    <SwiperSlide key ={index} className="w-full">
                                        ...
                                        items-center bg-pink-50/20">
                                            ...
                                            <div className="relative w-full h-full">
                                                <Image src = {project.image} fill className="oject-cover" alt=""/>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                );
